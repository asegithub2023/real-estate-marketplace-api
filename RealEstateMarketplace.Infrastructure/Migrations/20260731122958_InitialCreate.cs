        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PropertyFeaturesId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PropertyPropertyFeature", x => new { x.PropertiesId, x.PropertyFeaturesId });
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "bi-car-front", "Parking" },
                    { 2, "bi-water", "Swimming Pool" },
                    { 3, "bi-tree", "Garden" },
                    { 4, "bi-building", "Balcony" },
                    { 5, "bi-shield-check", "Security" },
                    { 6, "bi-arrow-up-square", "Elevator" },
                    { 7, "bi-wifi", "Internet" },
                    { 8, "bi-snow", "Air Conditioning" },
                    { 9, "bi-heart-pulse", "Gym" },
                    { 10, "bi-house-check", "Furnished" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Conversations_PropertyId_BuyerId_OwnerId",
                table: "Conversations",
                columns: new[] { "PropertyId", "BuyerId", "OwnerId" },
                unique: true);
